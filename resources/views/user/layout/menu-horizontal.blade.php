<ul class="horizontal-menu hidden py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-t border-[#ebedf2] dark:border-[#191e3a] dark:bg-[#0e1726] text-black dark:text-white-dark">
    ...
    <li class="menu nav-item relative">
        ...
        <ul class="sub-menu">
            ...
            <li>
                <a href="/analytics">Compras</a>
            </li>
            <li>
                <a href="/finance">Financeiro</a>
            </li>
            <li>
                <a href="/crypto">Mostruários</a>
            </li>
        </ul>
    </li>

    <!-- START - CONTATOS -->
    @canany(['contact-individual-read', 'contact-company-read'])
        <li class="menu nav-item relative">
            <a href="javascript:;" class="nav-link">
                <div class="flex items-center">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="shrink-0">
                    ...
                    <span class="px-1">{{ config('custom.categories.contacts.name') }}</span>
                </div>
                <div class="right_arrow">
                    <svg class="w-4 h-4 rotate-90" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <ul class="sub-menu">
                @can(['contact-individual-read'])
                    <li><a href="{{ Route('contact.individual') }}">CPF</a></li>
                @endcan
                @can(['contact-company-read'])
                    <li><a href="{{ Route('contact.individual') }}">CNPJ</a></li>
                @endcan
            </ul>
        </li>
    @endcanany
        ...
        <li class="menu nav-item relative">
            <a href="javascript:;" class="nav-link">
                <div class="flex items-center">
                    ...
                    <span class="px-1">{{ config('custom.categories.purchases.name') }}</span>
                </div>
                <div class="right_arrow">
                    <svg class="w-4 h-4 rotate-90" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <ul class="sub-menu">
                @can('purchase-read')
                    <li><a href="{{ route('purchases') }}">Faturas</a></li>
                @endcan
            </ul>
        </li>
    @endcanany
    ...
    <!-- START - SALES -->
    @canany(['sale-read', 'sale-attendance-read', 'sale-quote-read', 'sale-category-read'])
        <li class="menu nav-item relative">
            <a href="javascript:;" class="nav-link">
                <div class="flex items-center">
                    ...
                    <span class="px-1">{{ config('custom.categories.sales.name') }}</span>
                </div>
                <div class="right_arrow">
                    <svg class="w-4 h-4 rotate-90" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <ul class="sub-menu">
                @can('sale-read')
                    <li><a href="{{ Route('sales') }}">Faturas</a></li>
                @endcan

                @can('sale-attendance-read')
                    <li><a href="{{ Route('sale.attendances') }}">Atendimentos</a></li>
                @endcan
                ...
                @can('sale-category-read')
                    <li><a href="{{ Route('sale.categories') }}">Categorias</a></li>
                @endcan
            </ul>
        </li>
    @endcanany
    ...
    <!-- START - CATALOGS -->
    @canany(['catalog-item-read', 'catalog-showcase-read', 'catalog-category-read', 'catalog-variation-read'])
        <li class="menu nav-item relative">
            <a href="javascript:;" class="nav-link">
                <div class="flex items-center">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="shrink-0">
                    ...
                    <span class="px-1">{{ config('custom.categories.catalog.name') }}</span>
                </div>
                <div class="right_arrow">
                    <svg class="w-4 h-4 rotate-90" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <ul class="sub-menu">
                @can('catalog-item-read')
                    <li><a href="{{ Route('catalog.items') }}">Itens</a></li>
                @endcan

                @can('catalog-showcase-read')
                    <li><a href="{{ Route('catalog.showcases') }}">Mostruários</a></li>
                @endcan

                @can('catalog-category-read')
                    <li><a href="{{ Route('catalog.categories') }}">Categorias</a></li>
                @endcan

                @can('catalog-variation-read')
                    <li><a href="{{ Route('catalog.variations') }}">Váriações</a></li>
                @endcan
            </ul>
        </li>
    @endcanany
    ...
    <!-- START - TRANSACTIONS -->
    @canany(['transaction-account-read', 'transaction-categorie-read', 'transaction-goal-read', 'transaction-method-read', 'transaction-read', 'transaction-report-read'])
        <li class="menu nav-item relative">
            <a href="javascript:;" class="nav-link">
                <div class="flex items-center">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="shrink-0">
                    ...
                    <span class="px-1">{{ config('custom.categories.financial.name') }}</span>
                </div>
                <div class="right_arrow">
                    <svg class="w-4 h-4 rotate-90" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <ul class="sub-menu">
                @can('transaction-accounts-read')
                    <li> <a href="{{ Route('financial.account') }}">Caixa e Bancos</a></li>
                @endcan

                @can('transaction-category-read')
                    <li> <a href="{{ Route('financial.categories') }}">Categorias</a></li>
                @endcan

                @can('transaction-goal-read')
                    <li> <a href="{{ Route('financial.goals') }}">Metas</a></li>
                @endcan

                @can('transaction-method-read')
                    <li> <a href="{{ Route('financial.methods') }}">Métodos Pagamento</a></li>
                @endcan

                @can('transaction-read')
                    <li> <a href="{{ Route('financial.transactions') }}">Transações</a></li>
                @endcan

                @can('transaction-report-read')
                    <li> <a href="{{ Route('financial.reports') }}">Relatórios</a></li>
                @endcan
            </ul>
        </li>
    @endcanany
        ...
        <li class="menu nav-item relative">
            <a href="javascript:;" class="nav-link">
                <div class="flex items-center">
                    ...
                    <span class="px-1">{{ config('custom.categories.settings.name') }}</span>
                </div>
                <div class="right_arrow">
                    <svg class="w-4 h-4 rotate-90" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <ul class="sub-menu">
                @can('user-read')
                    <li> <a href="{{ Route('settings.users') }}">Usuários</a></li>
                @endcan

                @can('backup-read')
                    <li> <a href="{{ Route('settings.backups') }}">Backups</a></li>
                @endcan
            </ul>
        </li>
    @endcanany
