`<div class="flex gap-4 items-center">
    ...
    <a href="{{ Route('contact.individual.show', $ContactIndividual->id) }}" class="hover:text-primary">
    ...
    <a href="{{ Route('contact.individual.edit', $ContactIndividual->id) }}" class="hover:text-info">
    ...
    <a href="{{ Route('contact.individual.destroy', $ContactIndividual->id) }}" class="hover:text-info">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5">
